...
public class UsefulFile
  ...
  public UsefulFile( String fileName )
  throws IOException
    {
    this( fileName, "rw" );
    }

  public UsefulFile( String fileName, String mode )
  throws IOException
  ...
  */
  ...
  throws IOException
    ...
    for (int i=0; i<n; ++i)
      ...
      byte b;
      try { b = raf.readByte(); }
      catch (EOFException eofx) { sb.setLength( i ); return sb.toString(); }
  ...
  public static void mv ( String oldname, String newname )
  ...
  // This call will block until the lock is obtained.
    {
    if ( fileChannel == null ) fileChannel = raf.getChannel();
  ...
  public static String getTempFileName( String dir, String extention )
    ...
    while ( true )
      ...
      if ( !new File( trial ).exists() ) return( trial );
      }
    }
